...
var cases = []testCase{
	...
	{"keys/create-defaults", testKeyCreateDefaults},
	...
	{"users/create-key-default", testUserCreateKeyDefault},
	{"users/set-password", testUserSetPassword},
	{"users/set-password-authenticates", testUserSetPasswordAuthenticates},
